...
export default function Page() {
  return (
    <>
      ...
      <div className="m-4">
        <p className="my-4 text-4xl text-gray-900 dark:text-white">Intake Form</p>
        <p className="my-2 text-2xl text-gray-900 dark:text-white">Description</p>
        <p>This form comprises the initial intake questions before your first visit with Dr. Doe.</p>
        <p className="my-2 text-2xl text-gray-900 dark:text-white">Consent</p>
        <p>This form requires read & write access to Profile data.</p>
        <form className="max-w-md">
          <p className="mt-8 text-3xl text-gray-900 dark:text-white">Profile</p>
